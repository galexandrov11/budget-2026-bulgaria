        ...
        <Section id="intro" title="УВОД">
          ...
          <SubSection title="Контекст">
            <div className="prose prose-slate max-w-none text-slate-600 leading-relaxed space-y-4">
              <p>
                Бюджет 2026 е първият бюджет на България, който ще бъде изцяло деноминиран в евро след присъединяването
                към еврозоната на 1 януари 2026 г. Вместо да отбележи така желания плавен преход към новата валутна рамка,
                документът се превърна в епицентър на едно от най-острите политически и обществени противопоставяния
                през последните години. Това, което трябваше да бъде рутинен финансов проект, за кратко време предизвика
                мощен обществен трус и инструмент за политически атаки.
              </p>
              <p>
                Първата версия, внесена на 2 ноември, отключи остра и широка реакция. Недоволството бързо надхвърли
                рамките на традиционния диалог между синдикати и работодатели. Към критиците се присъединиха професионални
                общности, граждански организации и хиляди граждани, които видяха в проектобюджета знак за корупция и
                разминаване между политическите приоритети и реалните потребности за обществото. Последващите протести
                поставиха правителството под силен натиск и в крайна сметка доведоха до оттеглянето на първоначалния вариант.
              </p>
              <p>
                Последваха дни на интензивни преговори и напрегнат тристранен диалог. В резултат, на 5 декември беше
                представена преработена версия на бюджета, формирана под влиянието на обществения натиск и с осъзнатата
                необходимост политическото напрежение да бъде овладяно.
              </p>
              <p>
                Целта на анализа е да предостави максимално обективен преглед на разликите между двете внесени версии
                на бюджета, без политически или каквито и да било други субективни оценки. Документът съдържа единствено
                фактологично сравнение на числа, структури и законодателни текстове.
              </p>
              <p>
                ...
                съгласувана в рамките на тристранния диалог.
              </p>
            </div>
          </SubSection>
